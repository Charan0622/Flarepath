...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#050507] px-4 overflow-hidden">
      {/* Background glow effects */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#ff2d2d]/5 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-[#ff7b1c]/5 rounded-full blur-[100px]" />

      <div className="relative w-full max-w-sm space-y-8">
        <div className="text-center">
          <div className="relative inline-block">
            <span className="text-5xl">🚒</span>
            <div className="absolute -inset-4 bg-[#ff2d2d]/10 rounded-full blur-xl animate-pulse" />
          </div>
